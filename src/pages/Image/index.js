...
class Image extends Component {
                ...
                render: (text, data) => {
                    return (
                        <div
                            ...
                            onClick={() => {
                                this.handleClick(data.isDir, data.pathName);
                            }}
                        >
                            <img
                                ...
                                onClick={() =>
                                    !data.isDir && this.handleImageClick(data.pathName)
                                }
                            />
            ...
            },
            {
                    ...
                    return (
                        <div className="image-table-options">
                            <Button
                                type="primary"
                                onClick={() => {
                                    this.handleRemove(data.isDir, data.pathName);
                                }}
                            >
                                {" "}
                删除
              ...
              &nbsp; &nbsp;
                            <Button
                                type="primary"
                                onClick={() => {
                                    this.handleDownload(data.pathName);
                                }}
                            >
                                {" "}
                下载
  ...
  handleDownload(pathName) {
      window.open(imagesApi.downloadFile(pathName));
  }
      ...
      return (
          <div className="image">
                  ...
                  上传图片
                      ...
                      <div className="option-buttons fl">
                          <Button
                              ...
                              icon="plus"
                              onClick={() => {
                                  this.props.imagesStore.setCreateDirModalVisible(true);
                              }}
                          >
                新建文件夹
                          </Button>
              ...
              <CreateDirModal
                  ...
                  onCancel={() => {
                      this.props.imagesStore.setCreateDirModalVisible(false);
                  }}
              />
              <DisplayModal
